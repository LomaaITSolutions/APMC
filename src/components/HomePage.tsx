  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <section className="border mx-20 rounded-md shadow bg-white">
        <h2 className="text-primary font-bold px-4 py-2 text-lg">
          WHAT'S NEW
        </h2><hr />
         <ul className="p-4 list-disc list-inside space-y-2 text-blue-700">
          ...
          <li><a href="#">Applications for No Objection & Good Standing Certificates would be accepted only after the Final Registration Certificate issued by the APMC.</a></li>
          <li><a href="#">All the candidates are requested to get all orginal certificates from ssc / equivalent to higher education (UG / PG) in order to upload in the server.</a></li>
          <li><a href="#"> Applications for Renewal and Other Services in A.P Medical Council will not be accepted by Post or through a Third-Party.</a></li>
        </ul>
      </section>
      ...
      <section className="border mx-20 rounded-md shadow bg-white">
        ...
        <ul className="p-4 list-disc list-inside space-y-2 text-blue-700">
          <li><a href="#">Instructions for CME/CPD Programmes</a></li>
          <li><a href="#">For Online CME / Webinars / Conferences - 2 CDE Credit Hours / Points will be awarded per day for 6 hrs duration (as per NMC guidelines).</a></li>
        </ul>
      </section>
        ...
        <section className="border rounded-md shadow bg-white">
          ...
          <div className="p-4">
            <ul className="list-disc list-inside text-blue-700">
              <li><a href="#">Medical Colleges in A.P</a></li>
