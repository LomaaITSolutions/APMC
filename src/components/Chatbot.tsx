...
const Chatbot = () => {
  ...
  const predefinedResponses: Record<string, string> = {
    registration:
      "For medical registration, please visit our Online Services section. You'll need your qualification certificates, identity proof, and registration fee. The process typically takes 15-30 days for completion.\n\nWould you like to know more about:\n• Required documents\n• Fee structure\n• Registration process timeline\n• Renewal procedures",
            ...
            <ScrollArea className="flex-1 p-4">
              <div
                className={`space-y-4 overflow-y-scroll overflow-x-hidden ${
                  messages.length > 1 ? "h-[20rem]" : "h-auto"
                }`}
              >
                    ...
                    <div className="bg-muted rounded-lg p-3 max-w-[80%]">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex gap-1">
                          ...
                          <div
                            className="w-2 h-2 bg-medical-teal rounded-full animate-bounce"
