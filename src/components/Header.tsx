...
import { Menu, Phone, Mail, Search, X, ChevronDown, ChevronUp, Settings, Eye, FileSearch } from "lucide-react";
...
const [aboutOpen, setAboutOpen] = useState(false)
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
              <img src={apmcLogo} alt="APMC Logo" className="w-12 h-12 object-contain rounded-full" />
  ...
  <div className="hidden md:flex items-center gap-6">
    ...
    <div className="flex items-center gap-2">
      ...
      />
      <div>
        <p className="text-sm font-semibold">Sri Chandra Babu Naidu</p>
        <p className="text-xs text-muted-foreground">Hon'ble Chief Minister of Andhra Pradesh</p>
      </div>
    </div>
    ...
    <div className="flex items-center gap-2">
      ...
      />
      <div>
        <p className="text-sm font-semibold">Sri Satya Kumar Yadav</p>
        <p className="text-xs text-muted-foreground">Hon'ble Health, Medical & Family Welfare Minister</p>
      </div>
    </div>
  </div>
              ...
              <NavigationMenuList className="">
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <div className="w-80 p-4">
                      <div className="grid gap-2">
                        <Button variant="ghost" className="justify-start" onClick={() => navigate('/about/mission')}>
                          Mission
                        </Button>
                        <Button variant="ghost" className="justify-start" onClick={() => navigate('/about/vision')}>
                          Vision
                        </Button>
                  ...
                  <NavigationMenuContent>
                    <div className="w-80 p-4">
                      <div className="grid gap-2">
                        <Button variant="ghost" className="justify-start" onClick={() => navigate('/services/notification')}>
                          Notifications
                        </Button>
                        <Button variant="ghost" className="justify-start" onClick={() => navigate('/services/acts-rules')}>
                          Acts/Rules
                        </Button>
                        <Button variant="ghost" className="justify-start" onClick={() => navigate('/services/meetings-decisions')}>
                ...
                <NavigationMenuItem>
                  <Button variant="ghost" className="hover:text-primary" onClick={() => navigate('/contact')}>Contact Us</Button>
                </NavigationMenuItem>
              </NavigationMenuList>
            </NavigationMenu>
  ...
  <div className="lg:hidden mt-4 p-4 bg-accent rounded-lg">
    <nav className="flex flex-col ">
      ...
      <div className="pl-2">
        ...
        >
          About Us {aboutOpen ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
        </button>
        {aboutOpen && (
          <div className="flex flex-col gap-1 pl-4">
            <Button variant="ghost" className="justify-start text-sm" onClick={() => navigate('/about/mission')}>
              Mission
            </Button>
            <Button variant="ghost" className="justify-start text-sm" onClick={() => navigate('/about/vision')}>
              Vision
            </Button>
      ...
      <div className="pl-2">
        <button
          ...
          className="flex pl-2 py-2 items-center justify-between w-full text-left text-sm font-medium"
        >
          Services {serviceOpen ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
        </button>
        {serviceOpen && (
          <div className="flex flex-col gap-1 pl-4">
            <Button variant="ghost" className="justify-start text-sm" onClick={() => navigate('/services/notification')}>
              Notifications
            </Button>
            <Button variant="ghost" className="justify-start text-sm" onClick={() => navigate('/services/acts-rules')}>
              Acts/Rules
            </Button>
            <Button variant="ghost" className="justify-start text-sm" onClick={() => navigate('/services/meetings-decisions')}>
              Meetings and Decisions
            </Button>
      ...
      <div className="pl-2">
        <button
          ...
          className="flex pl-2 py-2 items-center justify-between w-full text-left text-sm font-medium"
        >
          CME {cmeOpen ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
        </button>
        {cmeOpen && (
          <div className="flex flex-col gap-1 pl-4">
      ...
      <div className="pl-2">
        ...
        >
          NRI Services {nriOpen ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
        </button>
        {nriOpen && (
      ...
      <Button variant="ghost" className="justify-start" onClick={() => navigate('/contact')}>Contact Us</Button>
    </nav>
