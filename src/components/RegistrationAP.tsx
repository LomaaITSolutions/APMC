      ...
      >
        ...
        >
          <h1 className="text-2xl font-bold text-center text-teal-700 italic mb-6">
            Registration For M.B.B.S Accomplished in Andhra Pradesh
          </h1>

          <div className="bg-white shadow-lg rounded-lg p-6 space-y-6">
            <h2 className="text-xl font-bold text-green-700">
              APMC Provisional Registration (TR) Details
            </h2>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Enter APMC Provisional Registration Number"
                className="w-full border rounded-lg px-4 py-2 mt-2 focus:ring-2 focus:ring-teal-500"
              />
              <p className="text-red-600 text-sm mt-1">
                * Registration Number as per APMC Provisional Certificate
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-red-600 text-sm mt-1">
                * Registration Date as per APMC Provisional Certificate
              </p>
            </div>
            ...
            <div>
              ...
              <select className="w-full border rounded-lg px-4 py-2 mt-2 focus:ring-2 focus:ring-teal-500">
                <option>-- Select Registration Place --</option>
