// src/pages/RegistrationOtherCountry.tsx
...
const RegistrationOtherCountry: React.FC = () => {
      ...
      >
        ...
        >
          <h1 className="text-2xl font-bold text-center text-teal-700 italic mb-6">
            Registration For M.B.B.S Accomplished in Other Country
          </h1>

          <div className="bg-white shadow-lg rounded-lg p-6 space-y-6">
            <h2 className="text-xl font-bold text-green-700">Screening Test Details</h2>

            {/* Screening Test Roll Number */}
            <div>
              <label className="block text-gray-700 font-medium">Screening Test Roll Number</label>
              <input
                type="text"
                placeholder="Enter Screening Test Roll Number"
            ...
            <div>
              <label className="block text-gray-700 font-medium">Screening Test Result Date</label>
              <input
                type="date"
                className="w-full border rounded-lg px-4 py-2 mt-2 focus:ring-2 focus:ring-teal-500"
              />
            ...
            {/* Screening Test Result Issued by */}
            <div>
              <label className="block text-gray-700 font-medium">Screening Test Result Issued by</label>
              <select className="w-full border rounded-lg px-4 py-2 mt-2 focus:ring-2 focus:ring-teal-500">
                <option>-- Select --</option>
                <option>National Board of Examinations (NBE)</option>
...
export default RegistrationOtherCountry;
