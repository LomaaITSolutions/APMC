                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        {notifications.map((notification) => {
                            ...
                            return (
                                <Card
                                    key={notification.id}
                                    className={`border border-border/50 shadow-card hover:shadow-medical transition-shadow ${!notification.read ? 'bg-medical-teal/5 border-medical-teal/20' : ''
                                        }`}
                                >
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-2">
                                                    <div className={`p-2 rounded-lg ${notification.type === 'important' ? 'bg-medical-red/10' :
                                                            notification.type === 'warning' ? 'bg-medical-orange/10' :
                                                                'bg-medical-blue/10'
                                                        }`}>
                                                        <NotificationIcon className={`w-5 h-5 ${notification.type === 'important' ? 'text-medical-red' :
                    ...
                    <div className="lg:w-80 space-y-6">
                        ...
                        <Card className="border border-border/50 shadow-card">
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <Button
                                    variant="outline"
                                    className="w-full justify-start border-teal-700 text-medical-orange hover:bg-gray hover:text-white"
                                >
